...
const pillow = s => {
    ...
    for(let i = 0; i < s0.length; i++){
        ...
        if(s0.charAt(i) === 'n' && s1.charAt(i)==='B') return true;
    }
...
console.log(pillow([ 'n', 'B' ]));
console.log(pillow(['\\DjQ\\[zv]SpG]Z/[Qm\\eLL', 'amwZArsaGRmibriXBgTRZp']));


//cw's solutions:

function pillow2 ([ first, second ]) {
    return !!first.split('').find((char, i) => char === 'n' && second[i] === 'B')
  }
