...
function stockList(listOfArt, listOfCat){
    ...
    listOfArt.forEach(e => {
        ...
        if(!organized.hasOwnProperty(temp[0].charAt(0))){

            organized[temp[0].charAt(0)] = parseInt(temp[1]);
    ...
    listOfCat.forEach((e,i)=>{



        output+= `(${e} : ${organized.hasOwnProperty(e) ? organized[e] : 0})${i===listOfCat.length-1 ? "" : " - "}`;
    });
